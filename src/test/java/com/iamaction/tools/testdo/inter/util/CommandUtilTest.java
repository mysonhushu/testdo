...
//        String testCaseFileUrl = "F:\\git-workspace\\testdo\\src\\main\\resources\\caseMethod_ntw.txt";
        CommandUtil instance = new CommandUtil();
        instance.setAppIp("10.175.163.26");
        instance.setMdIp("10.175.162.169");
        //TestCasesMapSRIForSM_NWK
        instance.setTestClass("TestCasesMapSRIForSM_APP");
//        instance.setTestClass("TestCasesMapSRIForSM_NWK");
